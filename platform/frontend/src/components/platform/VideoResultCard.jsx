...
export default function VideoResultCard({ result }) {
  ...
  return (
    <div className="rounded-2xl border border-white/10 bg-black/20 p-4 text-white">
      <div className="mb-3 text-xl font-semibold">{t.videoResult}</div>
      {!videoHref ? (
        <div className="text-white/60">{t.noVideo}</div>
        ...
        <div className="space-y-3">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="inline-flex rounded-lg bg-white px-4 py-2 text-black"
          >
        ...
        <div className="space-y-4">
          <video src={videoHref} controls className="w-full rounded-xl" />
