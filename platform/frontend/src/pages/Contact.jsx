  ...
  const developers = [
    {
      ...
      img: 'https://avatars.githubusercontent.com/u/51238895?v=4',
      telegram: 'https://t.me/ryen_ads',
            ...
            {developers.map((dev, i) => (
              <div key={i} className="bg-white/5 backdrop-blur-xl rounded-2xl p-6 border border-gray-700/50 text-center">
                ...
                <div className="flex justify-center gap-4">
                  <a href={dev.telegram} target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition-transform">
                    <svg className="w-6 h-6 fill-current text-sky-400 hover:text-sky-300" viewBox="0 0 24 24"><path d="M9.78 18.65c-.39 0-.32-.15-.45-.52l-1.12-3.69 8.63-5.46c.41-.25.79-.11.48.16l-6.99 6.31-.27 3.63c.39 0 .57-.18.79-.39l1.9-1.85 3.95 2.92c.73.4 1.25.19 1.43-.68l2.59-12.2c.26-1.07-.41-1.56-1.1-1.25L3.53 11.86c-1.05.42-1.04 1.01-.19 1.27l4.18 1.3 9.67-6.1c.46-.28.88-.12.54.18"/></svg>
                  </a>
